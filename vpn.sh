...
wget -q -O /etc/openvpn/easy-rsa/vars "https://raw.githubusercontent.com/Ianqitgu742543/jahqijwjaiabai86186443/main/vars.conf"
# edit projek export KEY_NAME="bokirtampan"
...
# install openvpn
wget -q -O /etc/openvpn/vpn.zip "https://raw.githubusercontent.com/Ianqitgu742543/jahqijwjaiabai86186443/main/vpn.zip"
cd /etc/openvpn/
unzip vpn.zip
rm -f vpn.zip
cd
...
iptables -t nat -I POSTROUTING -s 10.6.0.0/24 -o venet0 -j SNAT --to-source $MYIP
iptables -t nat -I POSTROUTING -s 10.7.0.0/24 -o venet0 -j SNAT --to-source $MYIP
...
iptables -t nat -A POSTROUTING -s 10.6.0.0/24 -o venet0 -j SNAT --to xxxxxxxxx
iptables -t nat -A POSTROUTING -s 10.7.0.0/24 -o venet0 -j SNAT --to xxxxxxxxx
END
